...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- CSS here -->
            ...
            <link rel="stylesheet" href="{{asset('assets/assets/css/price_rangs.css')}}">
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <span class="log">
                        <span style="color: #37756A" >THE</span>
                        <span style="color: #37756A" >NexHire</span>
                    </span>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-9 col-md-9">
                            <div class="menu-wrapper">
                                ...
                                <div class="header-btn d-none f-right d-lg-block">
                                    <a href="{{url('/signup')}}" class="btn head-btn1">Register</a>
                                 ...
                                 <div id="mc_embed_signup">
                                     ...
                                     method="get" class="subscribe_form relative mail_part">
                                         ...
                                         <div class="form-icon">
                                             ...
                                             class="email_icon newsletter-submit button-contactForm"><img src="{{asset('assets/assets/img/icon/form.png')}}" alt=""></button>
                                         </div>
  ...
  <!-- JS here -->
        ...
        <script src="{{asset('assets/assets/js/price_rangs.js')}}"></script>
        ...
        <script src="{{asset('assets/assets/js/jquery.scrollUp.min.js')}}"></script>
