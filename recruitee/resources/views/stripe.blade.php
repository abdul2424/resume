                    ...
                    <form 
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <input type="hidden" name="type" value="{{$plans->type}}">
                                <input type="hidden" name="name" value="{{$plans->name}}">
                                <input type="hidden" name="price" value="{{$plans->price}}">
    
                                <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now (${{ $plans->price }})</button>
                            </div>
                        </div>
